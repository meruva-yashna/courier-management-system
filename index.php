...
<body>
    <h1 align='center' style="margin: 15px; color:blue;font-weight: bold;font-family:'Times New Roman', Times, serif">SWIFT COURIER SERVICE</h1>
    <hr />
    <h3 align='center' style="font-weight: bold;color:blue;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</h3>
    <div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    ...
                    <p style="color: #e84118;">Don't have an account?⮞➤ <a href="register.php" style="color:black;">Register here</a>.</p>
