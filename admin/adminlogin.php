...
<head>
    ...
    <style>
        body
        {
        background-image:url('../images/747o.gif');
...
<body>
    ...
    <h4><a href="../index.php" style="float: right; margin-right:50px; color:White">Back To Home</a></h4><br>
    <h1 align='center' style="color: white;font-size:60px">Admin Login</h1>
    <h6 align='center' style="color: #212121;font-weight: bold;font-size:15px">Welcome Admin</h6>
